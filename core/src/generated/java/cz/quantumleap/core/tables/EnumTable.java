...
public class EnumTable extends TableImpl<EnumRecord> {
    ...
    private static final long serialVersionUID = -250577079;
     ...
     */
    public final TableField<EnumRecord, String> ID = createField("id", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>core.enum.name</code>.
     */
    public final TableField<EnumRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ENUM_PKEY);
    }
