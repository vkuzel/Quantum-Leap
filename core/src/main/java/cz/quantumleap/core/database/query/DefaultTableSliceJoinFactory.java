...
public final class DefaultTableSliceJoinFactory implements TableSliceJoinFactory {

    private final Entity<?> entity;
    private final EntityRegistry entityRegistry;

    public DefaultTableSliceJoinFactory(Entity<?> entity, EntityRegistry entityRegistry) {
        this.entity = entity;
