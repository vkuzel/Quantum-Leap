package cz.quantumleap.server.datafilter.web;
...
public class SliceRequestMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public SliceRequestMethodArgumentResolver(SortHandlerMethodArgumentResolver sortHandlerMethodArgumentResolver) {
