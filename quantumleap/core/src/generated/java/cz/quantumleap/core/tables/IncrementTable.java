...
public class IncrementTable extends TableImpl<Record> {

    private static final long serialVersionUID = 192693789;
     ...
     */
    public final TableField<Record, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('core.increment_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>core.increment.module</code>.
     */
    public final TableField<Record, String> MODULE = createField("module", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>core.increment.version</code>.
     */
    public final TableField<Record, Integer> VERSION = createField("version", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>core.increment.file_name</code>.
     */
    public final TableField<Record, String> FILE_NAME = createField("file_name", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
    ...
    private IncrementTable(String alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private IncrementTable(String alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.INCREMENT_PKEY);
    }
